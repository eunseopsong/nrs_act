#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Train B-spline policy on the latest single-camera imitation_form dataset."""
...
from bspline_train_core import build_arg_parser, run_one


PROJECT_ROOT = Path(__file__).resolve().parents[2]
DATASET_ROOT = PROJECT_ROOT / "datasets" / "polishing" / "single_cam"
CKPT_ROOT = PROJECT_ROOT / "checkpoints" / "bspline" / "polishing"
...
def main() -> None:
    ...
    parser.description = "Train B-spline policy with single-camera imitation_form data."
    parser.set_defaults(
        obs_mode="single_cam",
        camera_names=["cam0"],
